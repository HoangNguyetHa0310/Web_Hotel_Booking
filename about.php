        ...
        <div class="swiper mySwiper">
            <div class="swiper-wrapper mb-5">
                <div class="swiper-slide bg-white text-center overflow-hidden rounded">
                    <img src="images/about/management1.jpg" class="equal-image">
                    <h5 class="mt-2">Phan Van Hoang</h5>
                </div>

                <div class="swiper-slide bg-white text-center overflow-hidden rounded">
                    <img src="images/about/management2.jpg" class="equal-image">
                    <h5 class="mt-2">Hoang Nguyet Ha</h5>
                </div>

                <div class="swiper-slide bg-white text-center overflow-hidden rounded">
                    <img src="images/about/management3.jpg" class="equal-image">
                    <h5 class="mt-2">Tran Nal Do</h5>
                </div>

                <div class="swiper-slide bg-white text-center overflow-hidden rounded">
                    <img src="images/about/management4.jpg" class="equal-image">
                    <h5 class="mt-2">Le Van Si</h5>
                </div>

                <div class="swiper-slide bg-white text-center overflow-hidden rounded">
                    <img src="images/about/management5.jpg" class="equal-image">
                    <h5 class="mt-2">Dich Duong Thien Ti</h5>
                </div>

                <div class="swiper-slide bg-white text-center overflow-hidden rounded">
                    <img src="images/about/management6.jpg" class="equal-image">
